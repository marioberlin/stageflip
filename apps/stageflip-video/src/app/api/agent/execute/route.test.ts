...
// apps/stageflip-video/src/app/api/agent/execute/route.test.ts
// T-187c — verifies the video agent route's error-mapping contract.
    ...
    const req = makeRequest({
      ...
      document: {
        ...
        content: {
          ...
          durationMs: 30000,
          frameRate: 30,
          tracks: [{ id: 't', kind: 'visual', muted: false, elements: [] }],
        },
      },
    });
