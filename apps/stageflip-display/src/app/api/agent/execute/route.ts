// apps/stageflip-display/src/app/api/agent/execute/route.ts
// Phase-9 agent endpoint — wires Planner → Executor → Validator via
// the shared `@stageflip/app-agent` package. Mirrors the slide + video
// apps' route contract: Zod-validated strict body, 200/400/503/500
// error mapping, 503 when ANTHROPIC_API_KEY is absent.
