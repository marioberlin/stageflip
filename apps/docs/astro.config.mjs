...
const marketplaceSidebarUrl = new URL(
  './src/generated/marketplace-sidebar.json',
  import.meta.url,
);
let marketplaceSidebar = [];
try {
  marketplaceSidebar = JSON.parse(readFileSync(fileURLToPath(marketplaceSidebarUrl), 'utf8'));
} catch {
  // Generated by `scripts/build-marketplace-pages.ts` at prebuild.
}
