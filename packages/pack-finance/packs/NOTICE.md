# Earnings & Investor — Notice

This pack is distributed under a commercial subscription licence
issued by StageFlip. See LICENSE.md for the full terms.
...
"StageFlip", "Earnings & Investor", and all related names,
logos, and marks are trademarks of StageFlip. Use of
these marks outside the scope of identifying the source of this pack
requires prior written permission.

For all enquiries contact: licensing@stageflip.dev
