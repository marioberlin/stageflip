// packages/music-acestep/src/stub-audio.ts
// Deterministic silent-WAV generator for the stub-mode AceStepMusicProvider.
...
// (T-432a) replaces this with a real ACE-Step ONNX call; the
// surrounding shape (URL string) stays identical.
//
// Mirrors `packages/tts-kokoro/src/stub-audio.ts` verbatim — the
// silent-WAV emitter is sample-rate agnostic, so the same helper
// services the 44100Hz music-gen default and Kokoro's 24000Hz TTS
