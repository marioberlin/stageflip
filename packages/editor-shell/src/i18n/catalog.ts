...
const EN_CATALOG = new Map<string, string>([
  ...
  // Loss-flag reporter (T-248)
  ['lossFlags.badge.title', 'Import diagnostics'],
  ['lossFlags.badge.empty', 'No import diagnostics'],
  ['lossFlags.badge.count', '{count} import diagnostics'],
  ...
  ['lossFlags.modal.dismissAll', 'Dismiss all'],
  ['lossFlags.severity.info', 'Info'],
  ['lossFlags.severity.warn', 'Warn'],
  ['lossFlags.severity.error', 'Error'],
  ['lossFlags.category.shape', 'Shape'],
  ['lossFlags.category.animation', 'Animation'],
  ['lossFlags.category.font', 'Font'],
  ['lossFlags.category.media', 'Media'],
  ['lossFlags.category.theme', 'Theme'],
  ['lossFlags.category.script', 'Script'],
  ['lossFlags.category.other', 'Other'],
  ['lossFlags.row.dismiss', 'Dismiss'],
  ['lossFlags.row.locate', 'Go to slide'],
  ['lossFlags.row.locateUnavailable', 'Location does not resolve in the current document.'],
  ['lossFlags.row.source', 'src'],
