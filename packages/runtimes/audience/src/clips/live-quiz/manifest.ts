// packages/runtimes/audience/src/clips/live-quiz/manifest.ts
// T-465 — Co-located `AudienceClipManifest` declaration for the
// `live-quiz` clip family. Fifth audience clip on disk; follows the
// T-461..T-464 pattern verbatim.
//
...
/**
 * Co-located manifest for the `live-quiz` clip. The `permissions` tuple
