...
// T-461 — Co-located `AudienceClipManifest` declaration for the
// `live-poll-multiple-choice` clip family. The first audience clip on
// disk; sets the precedent T-462..T-471 follow.
//
...
/**
 * Co-located manifest for the `live-poll-multiple-choice` clip. The
