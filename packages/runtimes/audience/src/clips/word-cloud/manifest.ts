// packages/runtimes/audience/src/clips/word-cloud/manifest.ts
// T-467 — Co-located `AudienceClipManifest` declaration for the
// `word-cloud` clip family. Seventh audience clip on disk. Follows the
// T-461..T-466 pattern verbatim.
//
...
/**
 * Co-located manifest for the `word-cloud` clip. The `permissions`
