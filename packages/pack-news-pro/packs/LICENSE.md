# News Pro — Commercial License

Copyright (c) 2026 StageFlip

SPDX-License-Identifier: LicenseRef-StageFlip-Commercial-1.0

This pack (News Pro, SKU: news-pro-1y) is licensed under a commercial
...
StageFlip or an authorised reseller.
...
5. **Trademarks.** "StageFlip" and the News Pro
