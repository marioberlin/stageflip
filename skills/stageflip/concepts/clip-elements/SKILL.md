...
| `live-data` / `web-embed` / `ai-generative` | TBD | T-391+ |
...
invariant 11 covers `ai-chat` (T-389). New families register an
additional dispatch case in the same invariant series — no new gate
per family.
