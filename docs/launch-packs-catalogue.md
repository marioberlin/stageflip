...
| `finance` | `stageflip` | `0.1.0` | `finance-1y` | `paid-per-tenant` (commercial-subscription) | `cluster-finance` | skeleton landed in T-521, composition templates fill T-522..T-525. |
