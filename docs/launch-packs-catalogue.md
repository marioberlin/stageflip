...
| `frontier-fx` | `stageflip` | `0.2.0` | `frontier-fx-1y` | `paid-per-tenant` (commercial-subscription) | `cluster-i` | v0.2.0 GA — skeleton T-531; five premium shader presets T-532; pre-licensed commercial-OK 3D asset library T-533; five premium ReactionStream particle physics presets T-534; five premium TitleSequence templates T-535 (closes the pack AND closes P16 γ entirely — all 30 tasks T-506..T-535). |
