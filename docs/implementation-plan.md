...
| **T-131b [new]** | **`runtimes-frame-runtime-bridge` tier — 14 clips**: counter, pull-quote, subtitle-overlay, kinetic-text, typewriter-clip, logo-intro, light-leak, chart-build, pie-chart-build, line-chart-draw, comparison-table, stock-ticker, kpi-grid, animated-value. Each rewritten against `@stageflip/frame-runtime` (no Remotion imports), registered, parity fixture + golden | L |
