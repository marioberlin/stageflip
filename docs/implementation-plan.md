...
| ID | Task | Size |
|---|---|---|
| T-450 | ADR-009: Audience Backend — cites ADR-007; native + vendor adapter contract; real-time persistence model; rate limits; SLA target (1000 concurrent voters v1). (Renumbered from plan-stated ADR-008 per v1.26 — the original ADR-006/007 numbers shifted to ADR-007/008 to resolve the existing-ADR-006 collision.) | S |
...
**End of plan v1.27.** Start at T-001.
