...
| T-451 | ADR-010: Live Audience Clip Family — the 9 v1 clips; `staticFallback` snapshot semantics; `AudienceProvenance` schema. (Renumbered from plan-stated ADR-009 per v1.26.) | S |
...
**End of plan v1.28.** Start at T-001.
